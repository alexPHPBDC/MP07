...
{
    $plugin_js = plugins_url('facelog/assets/js/render.js'); //TODO Millorar-ho
    ...
    foreach ($users as $user) {
        ...
        $output .= "<canvas id='facelog_canvas_$user->user_login' width=$widthDesitjada height=$heightDesitjada> </canvas>";
    ...
    $output .= "</div>";
    $output .= "<script> 
    let widthDesitjada = " . $widthDesitjada . ";
    let heightDesitjada = " . $heightDesitjada . ";
    let velocitatGaleria = " . $velocitatGaleria . ";
    let facelog_data = " . json_encode($jsdata) . "</script>";
    $rand = rand();
